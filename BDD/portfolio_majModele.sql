...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 17 nov. 2021 à 08:34
...
('DoctrineMigrations\\Version20211117081132', '2021-11-17 08:11:37', 38584),
('DoctrineMigrations\\Version20211117081628', '2021-11-17 08:16:32', 1251);
...
--
-- Structure de la table `projet_def_groupe`
--

DROP TABLE IF EXISTS `projet_def_groupe`;
CREATE TABLE IF NOT EXISTS `projet_def_groupe` (
  `projet_def_id` int(11) NOT NULL,
  `groupe_id` int(11) NOT NULL,
  PRIMARY KEY (`projet_def_id`,`groupe_id`),
  KEY `IDX_DA8DFD5DD6911079` (`projet_def_id`),
  KEY `IDX_DA8DFD5D7A45358C` (`groupe_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `projet_type_projet_def`
--

DROP TABLE IF EXISTS `projet_type_projet_def`;
CREATE TABLE IF NOT EXISTS `projet_type_projet_def` (
  `projet_type_id` int(11) NOT NULL,
  `projet_def_id` int(11) NOT NULL,
  PRIMARY KEY (`projet_type_id`,`projet_def_id`),
  KEY `IDX_8BF1529E4766D1E2` (`projet_type_id`),
  KEY `IDX_8BF1529ED6911079` (`projet_def_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `rp` (`id`, `localisation_id`, `statut_id`, `source_id`, `cadre_id`, `niveau_rp_id`, `etudiant_id`, `enseignant_id`, `libcourt`, `besoin`, `date_debut`, `date_fin`, `environnement`, `moyen`, `date_modif`, `archivage`) VALUES
(12, 1, 2, 1, 1, 1, 53, 8, 'analyse besoin client', 'aaabbbcx', '2021-04-28', '2021-06-02', 'aaa xcxc', 'aaa', '2021-06-18', 1),
(13, 1, 3, 1, 1, 1, 53, NULL, 'real zak 2', 'aaa', '2021-04-28', '2021-06-02', 'aaa', 'aaa', '2021-05-31', 0),
(14, 1, 1, 1, 1, 1, 53, NULL, 'rp 3 zak', 'cdvx', '2021-05-27', '2021-05-28', 'vxv', 'cv', '2021-05-31', 0),
(16, 1, 1, 1, 1, 1, 54, NULL, 'etude comparative hébergeurs', 'héberger le site client', '2021-06-16', '2021-06-18', 'windows', 'pc', '2021-06-18', 0);
...
(1, 53, 7, 'Agrial', '12222', '1111Z', '12', 'qsdd', 'qsd', 'dsqdqs', 'Durand Benoit', '0101010101', 'bdurand@agrial.fr', 'Caen', 'evolution application de gestion des vaches', NULL, '2021-09-05', '2021-09-29', 5, '12-13', NULL, NULL, NULL, NULL, NULL),
...
(53, 64, NULL, 'zakina.rostand@gmail.com', '[\"ROLE_ETUDIANT\"]', '$argon2i$v=19$m=65536,t=4,p=1$dGJ6and2cTUzSlJUcmZDZg$uJdI4JHTIQbWgBuynhn+VR1jWZOxL1uQSyflFOgKzkk', 'twhiI7YrLFGZPB-gaVvTTi4XI3Lwzpg73XOtT4LmJZs', NULL, 'AC'),
(55, NULL, NULL, 'adminOld@rostand.fr', '[\"ROLE_ADMIN\"]', '$argon2i$v=19$m=65536,t=4,p=1$TllMN1ltcjVyOVh5cFFRVQ$N9rJHnsHuEOIBxAc3H6U2dbC2nK71Qc70qOT7fRE48Y', NULL, NULL, 'AC'),
...
--
-- Contraintes pour la table `projet_def_groupe`
--
ALTER TABLE `projet_def_groupe`
  ADD CONSTRAINT `FK_DA8DFD5D7A45358C` FOREIGN KEY (`groupe_id`) REFERENCES `groupe` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_DA8DFD5DD6911079` FOREIGN KEY (`projet_def_id`) REFERENCES `projet_def` (`id`) ON DELETE CASCADE;
...
--
-- Contraintes pour la table `projet_type_projet_def`
--
ALTER TABLE `projet_type_projet_def`
  ADD CONSTRAINT `FK_8BF1529E4766D1E2` FOREIGN KEY (`projet_type_id`) REFERENCES `projet_type` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_8BF1529ED6911079` FOREIGN KEY (`projet_def_id`) REFERENCES `projet_def` (`id`) ON DELETE CASCADE;
