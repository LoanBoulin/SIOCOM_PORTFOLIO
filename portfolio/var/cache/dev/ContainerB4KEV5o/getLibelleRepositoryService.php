 ...
 */
class getLibelleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LibelleRepository' shared autowired service.
     *
     * @return \App\Repository\LibelleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LibelleRepository.php';

        return $container->privates['App\\Repository\\LibelleRepository'] = new \App\Repository\LibelleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
