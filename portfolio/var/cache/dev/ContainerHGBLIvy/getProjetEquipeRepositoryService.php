 ...
 */
class getProjetEquipeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjetEquipeRepository' shared autowired service.
     *
     * @return \App\Repository\ProjetEquipeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjetEquipeRepository.php';

        return $container->privates['App\\Repository\\ProjetEquipeRepository'] = new \App\Repository\ProjetEquipeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
