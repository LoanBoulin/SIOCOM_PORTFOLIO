 ...
 */
class getGroupeTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GroupeTypeRepository' shared autowired service.
     *
     * @return \App\Repository\GroupeTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GroupeTypeRepository.php';

        return $container->privates['App\\Repository\\GroupeTypeRepository'] = new \App\Repository\GroupeTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
