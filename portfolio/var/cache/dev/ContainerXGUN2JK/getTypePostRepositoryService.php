 ...
 */
class getTypePostRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypePostRepository' shared autowired service.
     *
     * @return \App\Repository\TypePostRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypePostRepository.php';

        return $container->privates['App\\Repository\\TypePostRepository'] = new \App\Repository\TypePostRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
